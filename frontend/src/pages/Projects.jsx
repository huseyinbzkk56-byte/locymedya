  ...
  return (
    <Layout title="PR Projeleri">
      <div className="max-w-6xl mx-auto">
        ...
        {!isCompanyAdmin && <form onSubmit={submit} className="rounded-xl border border-gray-200 bg-gray-50 p-4 sm:p-5 mb-8">
